    ...
    return (
      <div className="flex flex-col gap-2 border-t border-border pt-3">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => setSuspending(false)} disabled={submitting} className="btn-ghost">
            Cancel
          </button>
        </div>
  ...
  return (
    <div className="flex flex-col gap-2 border-t border-border pt-3">
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={() => setReportStatus("DISMISSED")} disabled={submitting} className="btn-ghost">
          Dismiss
        </button>
